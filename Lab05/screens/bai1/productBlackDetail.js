...
export default function productBlackDetail({ navigation }) {
  return (
    <View style={styles.container}>
      <View style={styles.infoProduct}>
        <View style={styles.imgWrapper}>
          <Image source={require('../../assets/black.png')} style={styles.img} />
        </View>
        ...
        <View style={styles.textWrapper}>
          ...
          <Text style={{ marginBottom: 6 }}>
            Màu: <Text style={{ fontWeight: 'bold', color: 'black' }}>đen</Text>
          </Text>
      ...
      <View style={styles.buttonWapper}>
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('Điện thoại đen')}>
          XONG
        </TouchableOpacity>
      </View>
    </View>
