...
export default function productWhiteDetail({ navigation }) {
  return (
    <View style={styles.container}>
      <View style={styles.infoProduct}>
        <View style={styles.imgWrapper}>
          <Image source={require('../../assets/white.png')} style={styles.img} />
        </View>
        ...
        <View style={styles.textWrapper}>
          ...
          <Text style={{ marginBottom: 6 }}>
            Màu: <Text style={{ fontWeight: 'bold', color: 'black' }}>trắng</Text>
          </Text>
      ...
      <View style={styles.buttonWapper}>
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('Điện thoại trắng')}>
          XONG
        </TouchableOpacity>
      </View>
    </View>
