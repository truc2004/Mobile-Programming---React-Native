...
export default function App({ route, navigation }) {
  const { image, color, price, name } = route.params;  
    ...
    <View style={styles.container}>
      <View style={styles.infoProduct}>
        <View style={styles.imgWrapper}>
          <Image source={selectedImage} style={styles.img} />
        </View>
        ...
        <View style={styles.textWrapper}>
          ...
          <Text style={{ marginBottom: 6 }}>
            Màu: <Text style={{ fontWeight: 'bold', color: 'blue' }}>{selectedColor}</Text>
          </Text>
        ...
        <View style={styles.colorWapper}>
          <TouchableOpacity
            ...
            onPress={() => {
              ...
              setSelectedPrice(products[1]?.price);
              setSelectedColor("trắng");
              setSelectedName(products[1]?.name);
            }}
          />
        </View>
        <View style={styles.colorWapper}>
          <TouchableOpacity
            ...
            onPress={() => {
              ...
              setSelectedPrice(products[2]?.price);
              setSelectedColor("đỏ");
              setSelectedName(products[2]?.name);
            }}
          />
        </View>
        <View style={styles.colorWapper}>
          <TouchableOpacity
            ...
            onPress={() => {
              ...
              setSelectedPrice(products[3]?.price);
              setSelectedColor("đen");
              setSelectedName(products[3]?.name);
            }}
          />
        </View>
        <View style={styles.colorWapper}>
      ...
      <View style={styles.buttonWapper}>
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('ScreenBuy2', {
            image: selectedImage,
            price: selectedPrice,
            name: selectedName,
          })}>
